...
public struct ManagedBufferPointer<Value, Element> : Equatable {
    ...
    ///   call to `body`.
    public func withUnsafeMutablePointers<R>(@noescape body: (UnsafeMutablePointer<Value>, UnsafeMutablePointer<Element>) -> R) -> R
...
public struct UTF16 : UnicodeCodecType {
    ...
    public static func encode(input: UnicodeScalar, @noescape output put: (CodeUnit) -> Void)
}
...
public protocol UnicodeCodecType {
    ...
    /// Encode a `UnicodeScalar` as a series of `CodeUnit`s by
    /// calling `output` on each `CodeUnit`.
    public static func encode(input: UnicodeScalar, @noescape output: (Self.CodeUnit) -> Void)
}
...
public struct UnsafeMutablePointer<Memory> : RandomAccessIndexType, Hashable, NilLiteralConvertible, _PointerType {
    ...
    @available(*, deprecated, message="UnsafeMutablePointer() initializer will be removed in Swift 3.  Use `nil` instead")
    public init()
...
public struct UnsafePointer<Memory> : RandomAccessIndexType, Hashable, NilLiteralConvertible, _PointerType {
    public typealias Distance = Int
    /// Construct a null pointer.
    @available(*, deprecated, message="UnsafePointer() initializer will be removed in Swift 3.  Use `nil` instead")
    public init()
    /// Convert from an opaque C pointer to a typed pointer.
    ///
    /// This is a fundamentally unsafe conversion.
...
public func transcode<Input : GeneratorType, InputEncoding : UnicodeCodecType, OutputEncoding : UnicodeCodecType where InputEncoding.CodeUnit == Input.Element>(inputEncoding: InputEncoding.Type, _ outputEncoding: OutputEncoding.Type, _ input: Input, @noescape _ output: (OutputEncoding.CodeUnit) -> Void, stopOnError: Bool) -> Bool
